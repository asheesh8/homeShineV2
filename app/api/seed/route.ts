...
const SAMPLE_ASSESSMENTS: Assessment[] = [
  {
    ...
    aiSummary: {
      ...
      sources: [
        "Roof: Moss buildup should be treated with low-pressure roof-safe cleaning before it reaches shingles.",
        "Gutters: Free-flowing gutters with guards in good condition reduce water backup risk.",
  ...
  },
  {
    ...
    aiSummary: {
      ...
      sources: [
        "Roof: Heavy moss on north pitch needs roof-safe low-pressure treatment — pressure washing would damage shingles.",
        "Gutters: Overflow points may indicate sagging or blockage beyond surface debris.",
        "Driveway: Oil staining typically requires a degreaser pre-treatment before surface washing.",
        "Windows: 18 windows should be included as a line item in the service scope.",
      ],
